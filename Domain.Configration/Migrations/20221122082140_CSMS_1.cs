...
{
    public partial class CSMS_1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SparPart", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CarEngineNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Car_AspNetUsers_AccountId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_JobCard_Ticket_TicketId",
                        column: x => x.TicketId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SparPartId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    DateOfCreate = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_JobCard_SparPart", x => x.Id);
                    table.ForeignKey(
                        name: "FK_JobCard_SparPart_JobCard_JobCardId",
                        column: x => x.JobCardId,
                        principalTable: "JobCard",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_JobCard_SparPart_SparPart_SparPartId",
                        column: x => x.SparPartId,
                        principalTable: "SparPart",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobCard_TicketId",
                table: "JobCard",
                column: "TicketId");

            migrationBuilder.CreateIndex(
                name: "IX_JobCard_SparPart_JobCardId",
                table: "JobCard_SparPart",
                column: "JobCardId");

            migrationBuilder.CreateIndex(
                name: "IX_JobCard_SparPart_SparPartId",
                table: "JobCard_SparPart",
                column: "SparPartId");
