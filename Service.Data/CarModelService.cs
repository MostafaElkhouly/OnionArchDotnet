...
namespace Service.Data
{
    ...
    {
        public CarModelService(IRepository<CarModel> repository, IMapper mapper) : base(repository, mapper)
        {
        ...
        public List<ResReqCarModel> GetCarModelByParentId(Guid parentId)
        {
            ...
            var value = Repository.ToList(e => e.CarModelId == parentId);

            return mapper.Map<List<ResReqCarModel>>(value);
        }
    }
}
